...
import { AiOutlineCheckCircle,AiOutlineBarChart } from 'react-icons/ai';
import { FiTrendingUp, FiMessageCircle, FiPieChart, FiBarChart, FiCreditCard, FiStar, FiShoppingCart } from 'react-icons/fi';
  ...
  // },
   {
    ...
    links: [
      ...
      // },
      {
        name: 'MonthlyComplaints',
        icon: <AiOutlineBarChart />,
      },
      {
        name: 'YearlyComplaints',
        icon: <FiPieChart />,
      },
      // {
      //   name: 'financial',
...
export const recentTransactions = [
  {
    icon: <ImBin2 />,
    //amount: '+$350',
    desc: 'The garbage bins are not being cleaned regularly, leading to the growth of bacteria and unpleasant smells.',
    title: 'Garbage',
    iconColor: '#03C9D7',
    iconBg: '#E5FAFB',
    pcColor: 'green-600',
  },
  {
    ...
    //amount: '-$560',
    title: 'Electricity',
    desc: 'The electricity meters are faulty or inaccurate, leading to unfair billing and overcharging of residents.',
    iconColor: 'rgb(0, 194, 146)',
    iconBg: 'rgb(235, 250, 242)',
    pcColor: 'red-600',
  },
  {
    ...
    //amount: '+$350',
    title: 'Garbage',
    desc: 'The garbage bins are not being placed in suitable locations, leading to obstruction of traffic and pedestrian movement.',
    iconColor: 'rgb(255, 244, 229)',
    iconBg: 'rgb(254, 201, 15)',
  ...
  },
  {
    ...
    //amount: '+$350',
    title: 'Water Supply',
    desc: 'The water pressure is low, making it difficult for residents to use basic amenities such as showers and taps.',
  ...
  },
  {
    ...
    //percentage: '+38%',
    title: 'Roads',
    desc: 'The roads are being affected by illegal parking, leading to traffic congestion and safety risks.',
    iconColor: '#03C9D7',
    iconBg: '#E5FAFB',
    pcColor: 'red-600',
  },
...
export const ordersData = [
  {
       TicketID: 'fWXNYX',
       Name: 'Hema Zaveri',
       Complaint: 'The garbage bins are not being cleaned regularly, leading to the growth of bacteria and unpleasant smells.',
       Tag: 'Garbage Department',
       Address: 'Vadavali Section,Ambernath',
       Status: 'Open',
       StatusBg: '#8BE78B',
       ProductImage:
         product5,
     },
     {
      TicketID: 'qe15EC',
      Name: 'Bhavna Khanna',
      Complaint: 'The garbage collection service is not regular and there are delays in pick-ups, causing the accumulation of garbage in residential areas.',
      Tag: 'Garbage Department',
      Address: 'Kansai Section,Ambernath',
      Status: 'Open',
      StatusBg: '#8BE78B',
      ProductImage:
        product4,
    },
    {
      TicketID: 'JHkOW7',
      Name: 'Arnav Iyer',
      Complaint: 'The water supply is being contaminated by industrial or agricultural activities, posing a risk to public health.',
      Tag: 'Water Department',
      Address: 'Maha Laxmi Nagar,Ambernath',
      Status: 'In-progress',
      StatusBg: '#8BE78B',
      ProductImage:
        product3,
    },
    {
      TicketID: 'tSi7IR',
      Name: 'Brijesh Mishra',
      Complaint: 'The water supply is not sufficient to meet the needs of the community, leading to frequent shortages.',
      Tag: 'Water Department',
      Address: 'Maha Laxmi Nagar,Ambernath',
      Status: 'Resolved',
      StatusBg: '#8BE78B',
...
export const pieChartData = [
  { x: 'Garbage', y: 20, text: '20%' },
  { x: 'Electricity', y: 12, text: '12%' },
  { x: 'Water ', y: 23, text: '23%' },
  { x: 'Roads', y: 35, text: '35%' },
...
export const ecomPieChartData = [
  { x: 'Garbage', y: 20, text: '20%' },
  { x: 'Electricity', y: 10, text: '10%' },
  { x: 'Water', y: 12, text: '12%' },
  { x: 'Roads', y: 35, text: '35%' },
  { x: 'Others', y: 23, text: '23%' },
];
